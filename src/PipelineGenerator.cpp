...
void PipelineGenerator::extractShaderInfo()
{
    ...
    VkDescriptorSetLayout descriptorSetLayout; // TODO: Store this in a resource manager or something !it is leaking atm
    ...
    m_pipelineLayoutInfo.pSetLayouts = &descriptorSetLayout;
